...
const importStatusDefinitions: ImportStatusDefinition[] = [
  {
    ...
    detail: "로그 파일을 선택하거나 Demo Data로 대시보드에 진입할 수 있습니다.",
    tone: "muted",
  ...
  },
  {
    state: "processing",
    label: "Processing",
    title: "Streaming Decoder 실행 중",
    detail: "Web Worker가 파일을 순차 처리하며 01 03 / 01 04 레코드를 검증합니다.",
    tone: "lime",
  ...
  },
  {
    ...
    label: "Success",
    title: "스트리밍 처리 완료",
    detail: "전체 로그 문자열은 보관하지 않고 카운터와 처리 결과만 남겼습니다.",
    tone: "green",
  ...
  },
  {
    ...
    title: "지원하지 않는 파일",
    detail: "현재 Streaming Decoder 프로토타입은 .log 파일만 처리합니다.",
    tone: "amber",
    icon: <Ban size={20} aria-hidden="true" />,
  },
  {
